...
import IBaseRepository, { ContextParams, ModelClause, ModelType, PaginateContractType, PaginateParams } from './BaseInterface'
...
export default class BaseRepository<Model extends LucidModel> implements IBaseRepository<Model> {
   ...
   * Repository
   */
  public async list({ clauses, orders }: ContextParams<Model>): Promise<Array<InstanceType<Model>>> {
